...
public class GroupCheckService extends Service {
    ...
    public static GroupCheckNosWebSocketClient groupCheckNosWebSocketClient;
    private static final String NOTIFICATION_CHANNEL_ID = "notification";
    private int NOTIFICATION_ID = 1;
    private Gson gson;
    public static String SERVER_URI =
            "ws://10.0.2.2:8080/BoardGame_Web/GroupCheckServer/";
    ...
    public class GroupCheckNosWebSocketClient extends WebSocketClient {
        GroupCheckNosWebSocketClient(URI serverURI) {
        ...
        public void onMessage(String message) {
            Log.d(TAG, "GroupCheckOnMessage: " + message);
    ...
    public void connectServer() {
        ...
        if (groupCheckNosWebSocketClient == null) {
            groupCheckNosWebSocketClient = new GroupCheckNosWebSocketClient(uri);
            groupCheckNosWebSocketClient.connect();
        }
    }
    ...
    public void disconnectServer() {
        if (groupCheckNosWebSocketClient != null) {
            groupCheckNosWebSocketClient.close();
            groupCheckNosWebSocketClient = null;
        }
    }
