...
public class AdvertisementService extends Service {
    ...
    private final String TAG = "GroupCheckNosService";
    public static AdvertisementWebSocketClient advertisementWebSocketClient;
    private static final String NOTIFICATION_CHANNEL_ID = "notification";
    private int NOTIFICATION_ID = 1;
    private Gson gson;
    public static String SERVER_URI =
            "ws://10.0.2.2:8080/BoardGame_Web/AdvertisementServer/";
    ...
    public class AdvertisementWebSocketClient extends WebSocketClient {
        AdvertisementWebSocketClient(URI serverURI) {
        ...
        public void onMessage(String message) {
            Log.d(TAG, "AdvertisementOnMessage: " + message);
    ...
    public void connectServer() {
        ...
        if (advertisementWebSocketClient == null) {
            advertisementWebSocketClient = new AdvertisementWebSocketClient(uri);
            advertisementWebSocketClient.connect();
        }
    }
    ...
    public void disconnectServer() {
        if (advertisementWebSocketClient != null) {
            advertisementWebSocketClient.close();
            advertisementWebSocketClient = null;
        }
    }
